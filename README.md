...
- オンボーディング（表示名・事業開始年 / 申告方法 / 年間見込み・予備資金 / 完了、
  「あとで設定する」対応）
- 4タブのメイン画面の土台（ホーム/履歴/予測/設定。履歴以外はまだプレースホルダー）
- 売上・経費の追加/編集/削除、履歴一覧（すべて/売上/経費、月別グループ、スワイプ削除）
- TaxEngine本体（所得税・住民税・国民年金・国民健康保険・個人事業税の概算計算、境界値テスト付き）
- 年間集計・年間予測（自動予測/手動設定の区別）・「今年あと使えるお金」の計算ロジック
  （`Services/AllowanceCalculator`）
- ホーム画面（今年あと使えるお金・内訳表示）、予測タブ（自動予測/手動設定の切り替え）、
  設定タブ（プロフィール・対象年度・申告方法・税計算用プロフィール・社会保険・
  個人事業税区分・予備資金の管理）
